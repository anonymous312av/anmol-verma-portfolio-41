      ...
      >
        <div className="px-6 py-4 flex flex-col gap-4">
          ...
          <a
            href="/resume/Anmol_Verma_Resume.pdf"
            download="Anmol_Verma_Resume.pdf"
            className="inline-flex items-center justify-center gap-2 px-4 py-3 bg-primary text-primary-foreground text-sm font-medium rounded-lg hover:opacity-90 transition-opacity mt-2"
          >
            <Download size={16} />
            Download Resume
          </a>
