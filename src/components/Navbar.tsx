        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-accent text-accent-foreground text-sm font-medium rounded-lg hover:opacity-90 transition-all duration-300 hover:scale-105"
            >
              <Download size={16} />
              Resume
            </a>
      ...
      >
        <div className="px-6 py-4 flex flex-col gap-4">
          ...
          <a
            href="/resume/Anmol_Verma_Resume.pdf"
            download="Anmol_Verma_Resume.pdf"
            className="inline-flex items-center justify-center gap-2 px-4 py-3 bg-accent text-accent-foreground text-sm font-medium rounded-lg hover:opacity-90 transition-opacity mt-2"
          >
            <Download size={16} />
            Download Resume
          </a>
